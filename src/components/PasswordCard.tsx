      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-start z-10 relative">
            ...
            <button 
              ...
              className="p-2 bg-black/20 hover:bg-red-500/80 rounded-full text-white/70 hover:text-white transition-colors opacity-0 group-hover:opacity-100 border border-white/10 backdrop-blur-sm relative z-50"
        ...
        >
          ...
          <div className="px-6 py-4 flex-1 flex flex-col">
            <div className="text-[10px] uppercase tracking-widest text-white/70 mb-1 text-right w-full pointer-events-none">
            ...
            <div className="mt-auto text-[8px] text-white/50 text-center uppercase tracking-widest leading-relaxed px-4 pointer-events-none">
